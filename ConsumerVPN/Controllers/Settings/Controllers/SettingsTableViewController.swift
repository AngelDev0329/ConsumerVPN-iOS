...
class SettingsTableViewController: UITableViewController, VPNStatusReporting {
    ...
    override func viewDidLoad() {
        ...
        protocolSegmentControl.tintColor = .segmentedControl
    ...
    func restoreDefaultSettings() {
        ...
        // Set default product label for rate table cell.
        productLabel.text = LocalizedString.rate(productName: Theme.productName)
...
extension SettingsTableViewController {
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        cell.accessoryView?.tintColor = .cellAccessory
    }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0: // General
            ...
            case 1: // Rate Product
                // This will take the user to App Store for rating.
                print("This should go to the store")
			case 2: // Logout
                let title = LocalizedString.logoutAlertTitle
                var message = ""
                var actions : [UIAlertAction] = []
                
                if apiManager.status == VPNConnectionStatus.statusConnected || apiManager.status == VPNConnectionStatus.statusActive {
                    message = LocalizedString.logoutAlertMessageConnected
                } else {
                    message = LocalizedString.logoutAlertMessageDisconnected
                }
                ...
                actions.append(action)
                action = UIAlertAction(title: LocalizedString.logout, style: .destructive,handler: { (action) in
